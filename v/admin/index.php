		...
		<ul class="layui-tab-title">
 		...
 		<div class="layui-tab-content">
				<div class="layui-tab-item layui-show" name="基本设置">
						...
						<div class="layui-input-inline">
							<input type="text" name="yzm[yjurl]" value="<?php echo $yzm['yjurl']?>" size="30" class="layui-input upload-input"placeholder="标题url 如:https://tv.52meme.top">
						</div>
						...
						<div class="layui-form-mid layui-word-aux">播放器域名路径 例如：https://bfq.52meme.top/v/</div>
						</div>
                        ...
                        <div class="layui-form-mid layui-word-aux">播放器弹幕接口地址 例如：https://bfq.52meme.top/v/dmku/</div>
                    </div>
						...
						<div class="layui-form-mid layui-word-aux">弹幕框右边按钮链接 例如：https://tv.52meme.top/ggw/dmly.html</div>
						</div>
						<div class="layui-form-item">
