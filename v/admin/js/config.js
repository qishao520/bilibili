...
function text() {
  ...
  table.on('toolbar(dmlist)', function(obj){
   ...
   form.on('submit(bond_sumbit)', function (data) {
      ...
      function delreport (id) {$.ajax({url: "../v/dmku/?ac=del&type=report&id="+id,success: function(data){}});}
      function delid (id) {$.ajax({url: "../v/dmku/?ac=del&type=list&id="+id,success: function(data){}});}
   });
